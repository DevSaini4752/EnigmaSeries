...
Kindly choose one of the option (a/b/c/d/e/f) : {c.end}""").lower()
        ...
        if user_request == "a":
            ...
            print(f"{c.purple}Here is the documentation of the Project - Enigma 3.0{c.end}")
            documentation.documentation_open()

        elif user_request == "d":
            myjourney.journey_doc_open()
            ...
            {c.light_green}You can email me directly at: {c.bold}{c.light_purple}devsaini4752@gmail.com{c.end}
